...
class MathOps():
    ...
    def rel_to_global_3d(local_pos_3d: np.ndarray, global_pos_3d: np.ndarray, global_orientation_quat: np.ndarray) -> np.ndarray:
    ...
    @staticmethod
    def get_score_based_on_tanh(input, vertical_scaling=0.5, horizontal_scaling=1, vertical_shift=0.5, horizontal_shift=0) -> float:
        '''
